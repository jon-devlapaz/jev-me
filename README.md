...
[Grill-me](https://github.com/mattpocock/skills/blob/main/skills/productivity/grill-me/SKILL.md) with [Jev](https://docs.typesafe.ai) optional each turn. Jev stays off until you ask. If you ask and a closed 2–8 set is already on the table, one TypeSafe Choice is printed beside that question's `➡️` — not as the `➡️`.
